...
The encoder does not yet optimize Huffman tables, write restart intervals, embed
Exif/ICC metadata, or emit progressive scans. These are recorded explicitly in
